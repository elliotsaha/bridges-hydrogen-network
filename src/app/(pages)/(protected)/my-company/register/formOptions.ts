...
export const marketSegmentFocus = [
  {
    name: "Residential",
    description:
...
export const technologiesUsed = [
  ...
  },
  {
    ...
    technologies: ["Pipelines", "Tanker Trucks", "Rail", "Ships"],
  },
  {
    ...
    technologies: [
      ...
      "Grid Energy Storage",
      { name: "Hybrid Systems", tooltip: "(e.g. coupling with batteries)" },
      "Coupling with Carbon Capture and Storage",
    ],
  },
];
